...
const STATUS = { AUTH: 407 };
const [AUTHENTICATE, SUCCESS, FAILED] = ['AUTHENTICATE', 'SUCCESS', 'FAILED'];
const IDLE_CLIENT_TIMEOUT = 60 * 60 * 24 * 7;
const MAX_CLIENT_COUNT = 10000;
...
const HTTP_RESPONSES = {
    AUTH_REQUIRED: `HTTP/1.1 ${STATUS.AUTH} Proxy Authorization Required${CLRF}Proxy-Authenticate: Basic realm=""`,
